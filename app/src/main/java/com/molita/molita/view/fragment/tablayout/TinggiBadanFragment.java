...
public class TinggiBadanFragment extends Fragment {
    ...
    public TinggiBadanFragment(String idAnak, int umurAnak) {
        this.idAnak = idAnak;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tabViewModel.getPertumbuhanList().observe(getViewLifecycleOwner(), growthData -> {
            if (growthData != null) {
                ...
                String keterangan = TumbuhHelper.evaluateHeight(umurAnak, tinggiBadan);
